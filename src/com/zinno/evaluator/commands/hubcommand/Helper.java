...
import com.zinno.evaluator.gui.inventory.HelperInventory;
import com.zinno.evaluator.util.Translate;

import net.md_5.bungee.api.ChatColor;

public class Helper implements CommandExecutor, HubCommand {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		if(args == null || args.length == 0) {
			HelperInventory helperInv = new HelperInventory(plugin, player);
			player.openInventory(helperInv.getInv());
			return true;
		}
	...
	public void addSubCommand(List<String> alias, SubCommand subCommand) {
		Helper.subCommand.put(alias, subCommand);
	}
